...
Использовать Google Stitch через $google_stitch_skill.

ПРАВИЛА ЭТОЙ СЕССИИ:
1. view_file agents/ux_ui_designer.md → view_file $google_stitch_skill → deliverable → notify_user → ждать "Approved"
```
