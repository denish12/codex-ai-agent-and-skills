---
name: k8s-manifests-conventions
...
Стандарты для Kubernetes манифестов: naming, structure, overlays, validation.

**Разделы:**
1. [Tooling Decision](#1-tooling)
2. [Repo Structure](#2-repo-structure)
3. [Naming & Labels](#3-naming--labels)
4. [Config & Secrets](#4-config--secrets)
5. [Ingress & Gateway](#5-ingress)
6. [Probes & Resources](#6-probes--resources)
7. [Security Policy](#7-security)
8. [CI Validation](#8-ci-validation)
9. [GitOps](#9-gitops)
10. [Red Flags](#10-red-flags)
11. [Output Template](#11-output)

---

## 1. Tooling Decision

Выбери один подход и зафиксируй ADR:
...
## См. также
- `$docker-kubernetes-architecture` — containerization + K8s architecture
- `$deployment-ci-plan` — CI pipeline, environments, rollback
- `$security-baseline-dev` — secrets management patterns
- `$observability-plan` — logging/metrics in K8s context
