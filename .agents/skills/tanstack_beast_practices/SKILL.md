...
## См. также
- `react_beast_practices` → виртуализация (базовый пример)
- `typescript_beast_practices` → типизация generic запросов
- `dev_reference_snippets` → раздел 6 (базовые примеры useQuery/useMutation)
