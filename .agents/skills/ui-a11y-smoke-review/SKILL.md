...
> **Отличие от `$qa-ui-a11y-smoke`:** Этот скилл — дизайнерский quick check (5-10 мин, по UX Spec).
> `$qa-ui-a11y-smoke` — формальный QA тест (25 WCAG checks, tools, report).
...
1. Input:
   ...
   ├── UX Spec (из $ux-spec) — source of truth
   └── A11y Baseline (из $a11y-baseline) — requirements
