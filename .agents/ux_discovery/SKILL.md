...
## Факты из PRD
- Wix App — встраивается через iframe
- Dashboard для настройки popup-виджетов
- Roles: Site Owner (единственная роль)
- Templates: Glassmorphism, Neo-Brutalism, Minimal

## Уточнено
- Q-03: iframe внутри Wix Editor/Business Manager → 🔴 confirmed
- Q-13: Дизайн-система — WDS (Wix Design System) → 🟠 confirmed
- Q-17: Empty state — показать "Create your first coupon" CTA → 🟠 confirmed

## Допущения
- ASSUMPTION-01: Desktop-only (iframe в Wix Editor = десктоп) → Low risk
