...
| **Constraints** | Стек, деплой, сроки, интеграции | "Wix iframe, WDS, desktop-only" |
| **Inputs** | Ссылки на документы/файлы | "PRD: docs/prd.md, UX Discovery: ..." |
| **Decisions** | Что уже решено (нельзя менять без согласования) | "ADR-001: MongoDB, ADR-002: WDS" |
