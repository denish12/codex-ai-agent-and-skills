...
## См. также
- `dev_reference_snippets` → раздел 1 (TDD пример с slugify)
- `react_beast_practices` → тестирование компонентов (Testing Library)
- `typescript_beast_practices` → типизация моков и фикстур
