...
```markdown
# Test Plan: Smart Cart Rescue — Template v2

## Scope
- IN: Settings CRUD, Coupon CRUD, Widget rendering, Install webhook
- OUT: Wix marketplace publishing, multi-language (not in MVP)
...
## Entry: CI green, staging up, test app installed
