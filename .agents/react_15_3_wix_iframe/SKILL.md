...
## См. также
- `dev_reference_snippets` → раздел 10 «Legacy React 15.3» — дополнительные примеры
- Не используй `react_beast_practices` или `es2025_beast_practices` в Wix iFrame контексте
