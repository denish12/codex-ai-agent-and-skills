...
> Живые примеры и DO/DON'T — в `dev_reference_snippets`. Этот файл — архитектурный компас.
...
## См. также
- `dev_reference_snippets` — TDD, API-слои, Zustand, RTK, безопасность, legacy React 15.3
