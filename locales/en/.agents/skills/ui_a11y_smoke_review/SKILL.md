...
> **Difference from `$qa_ui_a11y_smoke`:** This skill is a designer's quick check (5-10 min, against UX Spec).
> `$qa_ui_a11y_smoke` is a formal QA test (25 WCAG checks, tools, report).
