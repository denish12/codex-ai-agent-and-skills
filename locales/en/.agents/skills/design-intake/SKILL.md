...
## Next Step
→ Proceed to $ux-spec / $design-parity-review
```

---

## See also
- `$ux-spec` — UX Spec (uses intake output)
- `$design-parity-review` — compare design with implementation
- `$ui-inventory` — component inventory
- `$google-stitch` — generate screens from text
