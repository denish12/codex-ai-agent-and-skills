...
## See also
- `$current_state_analysis` — before architecture changes
- `$adr_log` — detailed architectural decisions
- `$data_model` — complete DB schema
- `$deployment_ci_plan` — specific execution plan
