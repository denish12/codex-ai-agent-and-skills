---
name: pm-prd
description: Generate a PRD — Vision, MVP, out-of-scope, user stories, acceptance criteria, NFR, risks, and open questions. The result must be verifiable.
---

# Skill: PRD (Product Requirements Document)

A PRD that UX/ARCH/DEV/TEST can work from without "guessing".
...
```
1. Input: Interview Summary (from $pm-interview)
