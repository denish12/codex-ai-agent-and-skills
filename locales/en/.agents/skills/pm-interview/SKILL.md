...
| Situation | Action |
|----------|---------|
| User provided a detailed brief with answers to everything | Skip → go straight to $pm-prd |
...
## See also
- `$pm-prd` — PRD (output of interview)
- `$pm-backlog` — Backlog decomposition
- `$ux-discovery` — UX-specific discovery
