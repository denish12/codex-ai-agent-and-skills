...
## See also
- `$architecture_doc` — Use the analysis to propose the new architecture.
- `$system_design_checklist` — To ensure no areas are missed during redesign.
- `$security_review_baseline` — For deeper security audits.
