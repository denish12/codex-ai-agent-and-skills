...
Standard release checklist. Create before every Release Gate.
...
2. Fill statuses as evidence is collected
3. All blocking items (🔴) must be DONE for GO
4. Advisory items (🟡) can be N/A with justification
5. Pass checklist to $release_gate for final decision
```
...
|---|----------|-------|:---------:|--------|
| RG-01 | Evidence | Release scope + version/tag/commit specified | 🔴 | ☐ |
| RG-02 | Evidence | CI: unit tests PASS | 🔴 | ☐ |
| RG-03 | Evidence | CI: integration tests PASS | 🔴 | ☐ |
| RG-04 | Evidence | CI: lint/format PASS | 🟡 | ☐ |
| RG-05 | Evidence | Dependency/SCA audit PASS or risks recorded | 🟡 | ☐ |
...
| # | Category | Check | Blocking? | Status |
|---|----------|-------|:---------:|--------|
| RG-08 | DoD | No secrets in code/logs | 🔴 | ☐ |
| RG-09 | DoD | Runbook / startup instructions up to date | 🔴 | ☐ |
...
| RG-17 | Rollback | Rollback plan described and understood | 🔴 | ☐ |
...
| RG-20 | Post-deploy | Smoke test executed on target env | 🔴 | ☐ |
