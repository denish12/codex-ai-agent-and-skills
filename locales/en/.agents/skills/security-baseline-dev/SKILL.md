...
// ✅ Zod + validate middleware (see $node-express-beast-practices)
...
## See also
- `$security-review` — full security review checklist (Reviewer gate)
- `$node-express-beast-practices` — Express middleware pipeline, error handler
- `$observability-logging` — structured logging with redaction
- `$es2025-beast-practices` — safe data handling
