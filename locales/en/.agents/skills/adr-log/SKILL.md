...
## See also
- `$architecture-doc` — Architecture Document (ADR decisions referenced inline)
- `$current-state-analysis` — audit before new ADRs
- `$system-design-checklist` — design completeness checklist
