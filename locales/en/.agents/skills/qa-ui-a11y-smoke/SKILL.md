...
description: UI/a11y smoke — keyboard/focus, labels/aria, basic contrast, form and list states, match with UX Spec.
---

# Skill: QA UI & A11y Smoke

Basic check of UI accessibility and usability.
...
2. Keyboard navigation (section 3)
   └── Traverse all interactive elements with Tab
