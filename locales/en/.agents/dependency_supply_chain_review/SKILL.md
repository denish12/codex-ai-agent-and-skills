...
description: Review dependencies — minimization, updates, audit vulnerability, licenses, ban unsafe packages.
---

#Skill: Dependency & Supply Chain Review

Audit npm-dependencies: vulnerabilities, licenses, suspicious packages.
...
## See also
- `$security_review` — application security review
- `$security_baseline_dev` — secure coding patterns
- `$cloud_infrastructure_security` — CI/CD pipeline security
- `$tooling_bun_biome` — package manager setup