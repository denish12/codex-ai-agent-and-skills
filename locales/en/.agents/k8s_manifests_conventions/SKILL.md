...
description: Conventions for Kubernetes manifests — repository structure, Helm/Kustomize, overlays per env, naming/labels, secrets/config, policy, validation, GitOps.
---
...
Choose one approach and record ADR:
