---
name: qa_test_plan
description: Compose test plan and coverage matrix by PRD/UX — roles, critical user flows, states UI, negative cases, acceptance criteria.
---

# Skill: QA Test Plan

Test plan with coverage matrix by PRD/UX flows.
...
6. [Example: Smart Cart Rescue](#6-example)
...
1. Read PRD / UX Spec / Architecture Doc
   └── Highlight user flows and acceptance criteria

2. Determine scope:
   ├── What test (in scope)
   └── What Not test (out of scope + why)

3. Break it down into test suites by category:
