...
Record design how Source of Truth and extract verifiable rules.
...
```
1. Determine sources
   ├── Files in repositories (design/, docs/, assets/)
...
2. Classify each source
   ...
   └── Outdated (mark, not use)

3. For each SoT → extract spec (section 3)

4. Form Design Reference Map (screen → file)

5. Extract Design Rules (5-20 check rule)

6. Validate: all screens from PRD covered?
```
