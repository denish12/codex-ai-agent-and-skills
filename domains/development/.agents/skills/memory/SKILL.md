---
name: memory
description: Управление контекстом проекта — что сохранять, как извлекать, как избегать конфликтов решений и потери контекста между сессиями.
---

# Skill: Memory (контекст между сессиями)

Не терять контекст: решения, контракты, требования, результаты.

**Разделы:**
1. [Workflow](#1-workflow)
2. [What to Store](#2-store)
3. [Storage Strategy](#3-storage)
4. [Retrieval Patterns](#4-retrieval)
5. [Conflict Resolution](#5-conflicts)
6. [Session Handoff](#6-session)
