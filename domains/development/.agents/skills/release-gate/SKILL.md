...
Финальное решение GO / NO-GO / GO-with-conditions.
...
7. [Пример: Release Report](#7-пример)
...
```
1. Prereq: Generate RG checklist ($release-gate-checklist-template)
...
| RG Checklist (filled) | $release-gate-checklist-template | ✅ |
...
## См. также
- `$release-gate-checklist-template` — RG checklist (generate before this)
