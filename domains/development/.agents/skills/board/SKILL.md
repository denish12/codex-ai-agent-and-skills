...
```
1. Kickoff → создай Board из Backlog ($pm-backlog)
...
### PM Gate
- [☑] (PM-01) PRD: SaaS Admin Panel v1.0 — Owner: PM
- [☑] (PM-02) Backlog: 3 epics, 20 tasks — Owner: PM

### UX Gate
- [☑] (UX-01) UX Discovery completed — Owner: UX
- [⏳] (UX-02) UX Spec: Settings + Products screens — Owner: UX

### ARCH Gate
- [☐] (ARCH-01) Architecture Doc — Owner: ARCH — Deps: UX-02
- [☐] (ARCH-02) API Contracts (Settings, Products, Content) — Owner: ARCH
...
## См. также
- `$pm-backlog` — backlog (source of tasks)
- `$handoff` — gate transitions between agents
- `$gates` — pipeline gate definitions
- `$release-gate` — final release checklist
