...
- Which test mode is required? (a) Antigravity Browser for visual/manual-assisted checks via `$qa-browser-testing`, (b) Playwright CI/CD automation via `$qa-e2e-playwright`)
**Minimum:** 5 questions.
