...
## See also
- `react-beast-practices` → virtualization (basic example)
- `typescript-beast-practices` → typing generic queries
- `dev-reference-snippets` → section 6 (basic useQuery/useMutation examples)
