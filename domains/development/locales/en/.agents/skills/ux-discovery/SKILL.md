...
| Situation | Action |
|----------|---------|
| PRD already contains all answers | Skip discovery → go straight to $ux-spec |
...
## Next Step
→ Proceed to $ux-spec with confirmed facts + assumptions
```

---

## See also
- `$pm-prd` — PRD (input for discovery)
- `$ux-spec` — UX Spec (output of discovery)
- `$design-intake` — design materials analysis
