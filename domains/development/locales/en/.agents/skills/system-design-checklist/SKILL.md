...
## See also
- `$current-state-analysis` — current state audit (before this checklist)
- `$architecture-doc` — full Architecture Document (after checklist)
- `$adr-log` — recording decisions
