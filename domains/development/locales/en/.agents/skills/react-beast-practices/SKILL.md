...
> Real examples and DO/DON'T are in `dev-reference-snippets`. This file is an architectural compass.
...
## See also
- `dev-reference-snippets` — TDD, API layers, Zustand, RTK, security, legacy React 15.3
