...
## See also
- `$ui-inventory` — full UI inventory format
- `$styling-css-stack` — CSS tokens and naming
- `$ux-spec` — UX specification (defines states)
- `$a11y-baseline` — accessibility checklist
- `$design-parity-review` — comparison of implementation with design
