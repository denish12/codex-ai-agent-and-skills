...
> More details on E2E → `$qa-e2e-playwright`.
...
## See also
- `$tests-quality-review` — review of tests quality
- `$qa-e2e-playwright` — E2E via Playwright
- `$qa-browser-testing` — visual testing in Antigravity
- `$es2025-beast-practices` — modern JS for writing clean code
- `$dev-reference-snippets` — TDD, React, API examples
