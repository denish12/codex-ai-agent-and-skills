...
---
# HTML/PDF-отчёт — Генерация PRD или Product Review Deck в PDF

## Когда использовать
- При реализации **финального PRD** или **Product Review Deck** по Design Spec от Designer.
- При создании **self-contained HTML-файла** с Chart.js, Mermaid и print-optimized CSS.
- При генерации **PDF-ready документа** через Print-to-PDF в браузере или puppeteer.
- При вёрстке **PRD-документов** с user stories, таблицами (AC / RICE / metrics), roadmap-визуализациями и диаграммами.
...
**Файл:** docs/product/prd.html | docs/product/product-review-deck.html
**Размер:** ~XXX KB
